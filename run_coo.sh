...
--protocol.networkID="stardust-testnet" \
...
--snapshots.fullPath="snapshots/stardust-testnet/full_snapshot.bin" \
--snapshots.deltaPath="snapshots/stardust-testnet/delta_snapshot.bin" \
